// Node args specialist — configures a single node in a workflow
// Groups: core + node_args
...
const GROUPS = ['core', 'node_args'];

async function* runNodeArgsSpecialist({ messages, context, metadata, agentOverrides }) {
  const sideEvents = [];
  ...
  let systemPrompt = buildBasePrompt(context) + buildNodeArgsPrompt();
...
module.exports = { runNodeArgsSpecialist, GROUPS };

...
module.exports = {
  async close_crm_activity_search_reporting_get_activity(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/report/activity/";
    ...
    const bodyResult = utils.buildRequestBody(d, [{"key":"datetime_range","target":"datetime_range","type":"object"},{"key":"metrics","target":"metrics","type":"array"},{"key":"type","target":"type","type":"string"},{"key":"users","target":"users","type":"array"}]);

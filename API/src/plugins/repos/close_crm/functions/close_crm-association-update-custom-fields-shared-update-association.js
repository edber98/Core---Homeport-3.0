...
module.exports = {
  async close_crm_association_update_custom_fields_shared_update_association(node, msg, inputs, opts) {
    ...
    const bodyResult = utils.buildRequestBody(d, [{"key":"editable_with_roles","target":"editable_with_roles","type":"array"}]);

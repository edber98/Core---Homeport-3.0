...
module.exports = {
  async close_crm_lead_search_exports_create_lead(node, msg, inputs, opts) {
    ...
    const bodyResult = utils.buildRequestBody(d, [{"key":"date_format","target":"date_format","type":"string"},{"key":"format","target":"format","type":"string"},{"key":"results_limit","target":"results_limit","type":"string"},{"key":"s_query","target":"s_query","type":"object"},{"key":"send_done_email","target":"send_done_email","type":"boolean"},{"key":"sort","target":"sort","type":"array"},{"key":"type","target":"type","type":"string"}]);

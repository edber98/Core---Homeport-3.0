...
module.exports = {
  async close_crm_total_search_reporting_get_funnel_totals(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/report/funnel/opportunity/totals/";
    ...
    const bodyResult = utils.buildRequestBody(d, [{"key":"pipeline","target":"pipeline","type":"string"},{"key":"report_datetime_range","target":"report_datetime_range","type":"object"},{"key":"type","target":"type","type":"string"},{"key":"users","target":"users","type":"array"}]);

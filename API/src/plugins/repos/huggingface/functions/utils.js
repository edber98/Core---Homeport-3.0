async function huggingfaceRequest(opts, requestPath, options = {}) {
  ...
  const baseUrl = String(credentials.baseUrl || "https://router.huggingface.co").replace(/\/+$/, "");
...
module.exports = { utils: { huggingfaceRequest, parseJsonInput, compactJson, getPath, asArray, itemFromUnknown } };

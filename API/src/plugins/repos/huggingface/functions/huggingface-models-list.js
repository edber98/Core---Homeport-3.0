...
module.exports = {
  async huggingface_models_list(node, msg, inputs, opts) {
    ...
    const path = `https://huggingface.co/api/models`;
    const query = ({ search: d.search, pipeline_tag: d.pipelineTag, limit: d.limit });
    const body = {};

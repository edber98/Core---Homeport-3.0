async function sentryRequest(opts, requestPath, options = {}) {
  ...
  const baseUrl = String(credentials.baseUrl || "https://sentry.io/api/0").replace(/\/+$/, "");
...
module.exports = { utils: { sentryRequest, parseJsonInput, compactJson, getPath, asArray, itemFromUnknown } };

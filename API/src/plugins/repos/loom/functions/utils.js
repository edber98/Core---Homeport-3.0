function credentials(opts) {
  ...
  return { apiKey: c.apiKey || c.token || "", baseUrl: String(c.baseUrl || "https://api.loom.com/v1").replace(/\/+$/, ""), login: c.login || "", secretKey: c.secretKey || "", revision: c.revision || "2026-01-15" };
}
...
const ACTIONS = {
  ...
  "loom_folder_videos_list": {
    "path": "/folders/{folderId}/videos",
    "method": "GET",
    "query": [],
    "body": [],
    "json": [],

async function wiseRequest(opts, requestPath, options = {}) {
  ...
  const baseUrl = String(credentials.baseUrl || "https://api.wise.com").replace(/\/+$/, "");
...
module.exports = { utils: { wiseRequest, parseJsonInput, compactJson, getPath, asArray, itemFromUnknown } };

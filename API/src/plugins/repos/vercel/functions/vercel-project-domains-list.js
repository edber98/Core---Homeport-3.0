...
module.exports = {
  async vercel_project_domains_list(node, msg, inputs, opts) {
    ...
    const path = `/v9/projects/${encodeURIComponent(String(d.projectId))}/domains`;
    ...
    if (true) {
      const rawItems = utils.asArray(utils.getPath(res.data, "domains"));

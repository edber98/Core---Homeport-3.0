async function vercelRequest(opts, requestPath, options = {}) {
  ...
  const baseUrl = String(credentials.baseUrl || "https://api.vercel.com").replace(/\/+$/, "");
...
function coerceFieldValue(value, field) {
  ...
  if (type === "json") return parseJsonInput(value, key, undefined);
...
module.exports = { utils: { vercelRequest, parseJsonInput, buildBodyFromFields, compactJson, getPath, asArray, itemFromUnknown } };

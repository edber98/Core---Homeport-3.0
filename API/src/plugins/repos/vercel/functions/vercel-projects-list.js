...
module.exports = {
  async vercel_projects_list(node, msg, inputs, opts) {
    ...
    const query = ({ teamId: d.teamId, limit: d.pageSize, since: d.cursor });
    const body = {};
    ...
    if (true) {
      const rawItems = utils.asArray(utils.getPath(res.data, "projects"));

...
module.exports = {
  async vercel_env_list(node, msg, inputs, opts) {
    ...
    const path = `/v9/projects/${encodeURIComponent(String(d.projectId))}/env`;
    ...
    if (true) {
      const rawItems = utils.asArray(utils.getPath(res.data, "envs"));

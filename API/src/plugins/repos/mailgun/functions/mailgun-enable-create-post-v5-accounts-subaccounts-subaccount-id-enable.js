...
module.exports = {
  async mailgun_enable_create_post_v5_accounts_subaccounts_subaccount_id_enable(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v5/accounts/subaccounts/{subaccount_id}/enable";

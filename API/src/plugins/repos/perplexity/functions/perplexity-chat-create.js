...
module.exports = {
  async perplexity_chat_create(node, msg, inputs, opts) {
    ...
    const body = {
      model: String(d.model || "sonar").trim(),
      messages,
    ...
    log("Envoi du prompt...");
    const res = await utils.perplexityRequest(opts, "/chat/completions", { method: "POST", body });

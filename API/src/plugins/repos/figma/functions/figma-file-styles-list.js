...
module.exports = {
  async figma_file_styles_list(node, msg, inputs, opts) {
    ...
    const path = `/files/${encodeURIComponent(String(d.fileKey))}/styles`;
    const query = {};
    const body = {};
    ...
    if (true) {
      const rawItems = utils.asArray(utils.getPath(res.data, "meta.styles"));

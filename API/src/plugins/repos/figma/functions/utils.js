async function figmaRequest(opts, requestPath, options = {}) {
  ...
  const baseUrl = String(credentials.baseUrl || "https://api.figma.com/v1").replace(/\/+$/, "");
...
module.exports = { utils: { figmaRequest, parseJsonInput, compactJson, getPath, asArray, itemFromUnknown } };

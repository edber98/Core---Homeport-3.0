async function miroRequest(opts, requestPath, options = {}) {
  ...
  const baseUrl = String(credentials.baseUrl || "https://api.miro.com/v2").replace(/\/+$/, "");
...
module.exports = { utils: { miroRequest, parseJsonInput, compactJson, getPath, asArray, itemFromUnknown } };

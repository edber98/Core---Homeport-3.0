...
module.exports = {
  async activecampaign_bulkcreate_create_deal_bulkcreatecustomfieldvalues(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/dealCustomFieldData/bulkCreate";
    ...
    const body = {};
    if (d.array_dealid !== undefined && d.array_dealid !== null && d.array_dealid !== "") {
          if (!body["array"] || typeof body["array"] !== 'object' || Array.isArray(body["array"])) body["array"] = {};
          body["array"]["dealid"] = d.array_dealid;
        }

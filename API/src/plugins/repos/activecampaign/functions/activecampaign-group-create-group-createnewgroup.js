...
module.exports = {
  async activecampaign_group_create_group_createnewgroup(node, msg, inputs, opts) {
    ...
    if (d.group_pgtagmanage !== undefined && d.group_pgtagmanage !== null && d.group_pgtagmanage !== "") {
          if (!body["group"] || typeof body["group"] !== 'object' || Array.isArray(body["group"])) body["group"] = {};
          body["group"]["pgtagmanage"] = d.group_pgtagmanage;
        }

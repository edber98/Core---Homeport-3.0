...
module.exports = {
  async activecampaign_ecomorder_create_order_createneworder(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/ecomOrders";
    ...
    if (d.ecomorder_source !== undefined && d.ecomorder_source !== null && d.ecomorder_source !== "") {
          if (!body["ecomorder"] || typeof body["ecomorder"] !== 'object' || Array.isArray(body["ecomorder"])) body["ecomorder"] = {};
          body["ecomorder"]["source"] = d.ecomorder_source;
        }
    ...
    if (d.ecomorder_connectionid !== undefined && d.ecomorder_connectionid !== null && d.ecomorder_connectionid !== "") {
          if (!body["ecomorder"] || typeof body["ecomorder"] !== 'object' || Array.isArray(body["ecomorder"])) body["ecomorder"] = {};
          body["ecomorder"]["connectionid"] = d.ecomorder_connectionid;
        }
    if (d.ecomorder_customerid !== undefined && d.ecomorder_customerid !== null && d.ecomorder_customerid !== "") {
          if (!body["ecomorder"] || typeof body["ecomorder"] !== 'object' || Array.isArray(body["ecomorder"])) body["ecomorder"] = {};
          body["ecomorder"]["customerid"] = d.ecomorder_customerid;
        }
    ...
    if (d.ecomorder_externalcreateddate !== undefined && d.ecomorder_externalcreateddate !== null && d.ecomorder_externalcreateddate !== "") {
          if (!body["ecomorder"] || typeof body["ecomorder"] !== 'object' || Array.isArray(body["ecomorder"])) body["ecomorder"] = {};
          body["ecomorder"]["externalcreateddate"] = d.ecomorder_externalcreateddate;
        }

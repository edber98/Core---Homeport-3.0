...
module.exports = {
  async activecampaign_message_update_message_updatebyid(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/messages/{id}";
    ...
    if (d.message_fromemail !== undefined && d.message_fromemail !== null && d.message_fromemail !== "") {
          if (!body["message"] || typeof body["message"] !== 'object' || Array.isArray(body["message"])) body["message"] = {};
          body["message"]["fromemail"] = d.message_fromemail;
        }
    ...
    if (d.message_name !== undefined && d.message_name !== null && d.message_name !== "") {
          if (!body["message"] || typeof body["message"] !== 'object' || Array.isArray(body["message"])) body["message"] = {};
          body["message"]["name"] = d.message_name;
        }
    if (d.message_text !== undefined && d.message_text !== null && d.message_text !== "") {
          if (!body["message"] || typeof body["message"] !== 'object' || Array.isArray(body["message"])) body["message"] = {};
          body["message"]["text"] = d.message_text;
        }
    if (d.message_html !== undefined && d.message_html !== null && d.message_html !== "") {
          if (!body["message"] || typeof body["message"] !== 'object' || Array.isArray(body["message"])) body["message"] = {};
          body["message"]["html"] = d.message_html;
        }

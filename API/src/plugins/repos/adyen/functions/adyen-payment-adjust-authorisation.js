...
module.exports = {
  async adyen_payment_adjust_authorisation(node, msg, inputs, opts) {
    ...
    log("Ajustement d'autorisation...");
    const res = await utils.adyenRequest(opts, `/payments/${encodeURIComponent(paymentPspReference)}/amountUpdates`, {
      method: "POST",
      body,

...
module.exports = {
  async appsmith_application_static_slug_update(node, msg, inputs, opts) {
    const d = inputs || {};
    const query = {};
...
const options = {};
    ...
    const res = await utils.appsmithRequest(opts, `/api/v1/applications/${encodeURIComponent(String(d.branchedApplicationId || "").trim())}/static-url`, { method: 'PATCH', query, ...options });

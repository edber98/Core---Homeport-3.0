...
module.exports = {
  async appsmith_workspace_logo_upload(node, msg, inputs, opts) {
    const d = inputs || {};
    const query = {};
...
const options = {};
    ...
    const res = await utils.appsmithRequest(opts, `/api/v1/workspaces/${encodeURIComponent(String(d.workspaceId || "").trim())}/logo`, { method: 'POST', query, ...options });

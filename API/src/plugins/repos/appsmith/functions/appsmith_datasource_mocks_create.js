...
module.exports = {
  async appsmith_datasource_mocks_create(node, msg, inputs, opts) {
    const d = inputs || {};
    const query = {};
...
const options = {};
    ...
    const res = await utils.appsmithRequest(opts, `/api/v1/datasources/mocks`, { method: 'POST', query, ...options });

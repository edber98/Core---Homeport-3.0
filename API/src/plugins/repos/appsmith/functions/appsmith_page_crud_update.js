...
module.exports = {
  async appsmith_page_crud_update(node, msg, inputs, opts) {
    const d = inputs || {};
    const query = {};
...
const options = {};
    ...
    const res = await utils.appsmithRequest(opts, `/api/v1/pages/crud-page/${encodeURIComponent(String(d.branchedPageId || "").trim())}`, { method: 'PUT', query, ...options });

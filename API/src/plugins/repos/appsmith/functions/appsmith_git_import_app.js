...
module.exports = {
  async appsmith_git_import_app(node, msg, inputs, opts) {
    const d = inputs || {};
    const query = {};
...
const options = {};
    ...
    const res = await utils.appsmithRequest(opts, `/api/v1/git/import/${encodeURIComponent(String(d.workspaceId || "").trim())}`, { method: 'POST', query, ...options });

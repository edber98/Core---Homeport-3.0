...
module.exports = {
  async appsmith_application_update(node, msg, inputs, opts) {
    const d = inputs || {};
    ...
    const res = await utils.appsmithRequest(opts, `/api/v1/applications/${encodeURIComponent(appId)}`, { method: "PATCH", json: bodyJson });

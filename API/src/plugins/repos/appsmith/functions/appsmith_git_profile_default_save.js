...
module.exports = {
  async appsmith_git_profile_default_save(node, msg, inputs, opts) {
    const d = inputs || {};
    const query = {};
...
const options = {};
    ...
    const res = await utils.appsmithRequest(opts, `/api/v1/git/profile/default`, { method: 'POST', query, ...options });

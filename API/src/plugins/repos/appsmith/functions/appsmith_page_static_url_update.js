...
module.exports = {
  async appsmith_page_static_url_update(node, msg, inputs, opts) {
    const d = inputs || {};
    const query = {};
...
const options = {};
    ...
    const res = await utils.appsmithRequest(opts, `/api/v1/pages/static-url`, { method: 'PATCH', query, ...options });

...
module.exports = {
  async instantly_account_update_patchaccount(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v2/accounts/{email}";
    ...
    if (d.remove_tracking_domain !== undefined && d.remove_tracking_domain !== null && d.remove_tracking_domain !== '') {
      body["remove_tracking_domain"] = d.remove_tracking_domain;
    }

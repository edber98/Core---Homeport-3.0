...
module.exports = {
  async instantly_email_service_provider_option_list_getinboxplacementtestespoptions(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v2/inbox-placement-tests/email-service-provider-options";

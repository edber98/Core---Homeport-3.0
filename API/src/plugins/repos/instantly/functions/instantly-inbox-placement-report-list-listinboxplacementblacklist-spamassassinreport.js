...
module.exports = {
  async instantly_inbox_placement_report_list_listinboxplacementblacklist_spamassassinreport(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v2/inbox-placement-reports";

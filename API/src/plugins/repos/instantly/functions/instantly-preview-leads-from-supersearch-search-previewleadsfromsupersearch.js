...
module.exports = {
  async instantly_preview_leads_from_supersearch_search_previewleadsfromsupersearch(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v2/supersearch-enrichment/preview-leads-from-supersearch";

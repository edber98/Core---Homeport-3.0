...
module.exports = {
  async instantly_stats_by_test_id_create_getinboxplacementanalyticsstatsbytestid(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v2/inbox-placement-analytics/stats-by-test-id";
    ...
    const body = {};
    if (d.test_ids !== undefined && d.test_ids !== null && d.test_ids !== '') {
      body["test_ids"] = d.test_ids;
    }

...
module.exports = {
  async smartlead_warmup_stat_list_api_reference_email_accounts_warmup_stats(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/email-accounts/{email_account_id}/warmup-stats";

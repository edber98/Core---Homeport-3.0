...
module.exports = {
  async smartlead_unsubscribe_create_api_reference_campaigns_unsubscribe_lead(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/campaigns/{campaign_id}/leads/{lead_id}/unsubscribe";

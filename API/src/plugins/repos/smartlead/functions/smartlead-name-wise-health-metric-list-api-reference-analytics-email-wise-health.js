...
module.exports = {
  async smartlead_name_wise_health_metric_list_api_reference_analytics_email_wise_health(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/mailbox/name-wise-health-metrics";

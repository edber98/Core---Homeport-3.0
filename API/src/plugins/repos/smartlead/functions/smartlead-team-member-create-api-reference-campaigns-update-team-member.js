...
module.exports = {
  async smartlead_team_member_create_api_reference_campaigns_update_team_member(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/campaigns/{campaign_id}/team-member";

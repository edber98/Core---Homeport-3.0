...
module.exports = {
  async smartlead_top_level_analytics_by_date_list_api_reference_campaigns_get_top_level_analytics(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/campaigns/{campaign_id}/top-level-analytics-by-date";

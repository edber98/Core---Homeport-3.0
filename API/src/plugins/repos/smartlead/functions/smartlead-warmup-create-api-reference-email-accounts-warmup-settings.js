...
module.exports = {
  async smartlead_warmup_create_api_reference_email_accounts_warmup_settings(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/email-accounts/{email_account_id}/warmup";

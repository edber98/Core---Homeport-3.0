...
module.exports = {
  async smartlead_leads_take_for_first_reply_list_api_reference_analytics_leads_for_first_reply(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/campaign/leads-take-for-first-reply";

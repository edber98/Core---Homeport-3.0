...
module.exports = {
  async smartlead_day_wise_overall_stats_by_sent_time_list_api_reference_analytics_day_wise_sent_time(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/day-wise-overall-stats-by-sent-time";

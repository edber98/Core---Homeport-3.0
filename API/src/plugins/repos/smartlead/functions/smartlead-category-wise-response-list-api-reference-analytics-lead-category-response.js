...
module.exports = {
  async smartlead_category_wise_response_list_api_reference_analytics_lead_category_response(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/lead/category-wise-response";

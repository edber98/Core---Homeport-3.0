...
module.exports = {
  async smartlead_mailbox_statistic_list_api_reference_campaign_statistics_mailbox_statistics(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/campaigns/{campaign_id}/mailbox-statistics";

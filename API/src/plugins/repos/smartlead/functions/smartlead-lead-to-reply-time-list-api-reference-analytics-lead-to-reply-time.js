...
module.exports = {
  async smartlead_lead_to_reply_time_list_api_reference_analytics_lead_to_reply_time(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/campaign/lead-to-reply-time";

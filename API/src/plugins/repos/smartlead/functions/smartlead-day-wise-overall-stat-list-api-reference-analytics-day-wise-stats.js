...
module.exports = {
  async smartlead_day_wise_overall_stat_list_api_reference_analytics_day_wise_stats(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/day-wise-overall-stats";

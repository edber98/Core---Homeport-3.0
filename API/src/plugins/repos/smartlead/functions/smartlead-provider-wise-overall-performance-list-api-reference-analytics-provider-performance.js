...
module.exports = {
  async smartlead_provider_wise_overall_performance_list_api_reference_analytics_provider_performance(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/mailbox/provider-wise-overall-performance";

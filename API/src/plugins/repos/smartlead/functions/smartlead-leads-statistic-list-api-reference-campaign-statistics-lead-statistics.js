...
module.exports = {
  async smartlead_leads_statistic_list_api_reference_campaign_statistics_lead_statistics(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/campaigns/{campaign_id}/leads-statistics";

...
module.exports = {
  async smartlead_response_stat_list_api_reference_analytics_campaign_response_stats(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/campaign/response-stats";

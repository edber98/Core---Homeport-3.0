...
module.exports = {
  async smartlead_email_account_create_api_reference_campaigns_add_email_accounts(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/campaigns/{campaign_id}/email-accounts";

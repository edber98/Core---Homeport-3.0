...
module.exports = {
  async smartlead_month_wise_count_list_api_reference_analytics_month_wise_client_count(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/api/v1/analytics/client/month-wise-count";

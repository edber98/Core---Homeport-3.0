...
module.exports = {
  async customer_io_language_create_createnewslettertestlanguagevariant(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/newsletters/{newsletter_id}/test_group/{test_group_id}/language";

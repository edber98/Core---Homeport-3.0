...
module.exports = {
  async customer_io_subscription_preference_search_getpersonsubscriptionpreferences(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/customers/{customer_id}/subscription_preferences";

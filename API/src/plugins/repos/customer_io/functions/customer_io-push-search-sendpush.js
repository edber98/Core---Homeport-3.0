...
module.exports = {
  async customer_io_push_search_sendpush(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/send/push";

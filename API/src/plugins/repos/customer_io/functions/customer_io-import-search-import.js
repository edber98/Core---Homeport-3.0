...
module.exports = {
  async customer_io_import_search_import(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/imports";
    ...
    const bodyResult = utils.buildRequestBody(d, [{"key":"import","target":"import","type":"object"}]);

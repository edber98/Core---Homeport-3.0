...
module.exports = {
  async customer_io_object_search_getobjectsfilter(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/objects";
    ...
    const bodyResult = utils.buildRequestBody(d, [{"key":"objectTypeId","target":"object_type_id","type":"string"},{"key":"filter","target":"filter","type":"object"}]);

...
module.exports = {
  async customer_io_suppression_search_getdomainsuppressionsbytype(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/esp/domains/{domain_name}/suppression/{suppression_type}";

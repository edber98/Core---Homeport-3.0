...
module.exports = {
  async revolut_business_expense_list(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/expenses";
    ...
    if (d.merchant !== undefined && d.merchant !== null && d.merchant !== '') query["merchant"] = d.merchant;

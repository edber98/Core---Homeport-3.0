...
module.exports = {
  async sendgrid_suppression_search_post_asm_groups_group_id_suppressions_search(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/asm/groups/{group_id}/suppressions/search";

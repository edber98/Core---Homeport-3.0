...
module.exports = {
  async sendgrid_field_definition_delete_delete_mc_field_definitions_custom_field_id(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/marketing/field_definitions/{custom_field_id}";

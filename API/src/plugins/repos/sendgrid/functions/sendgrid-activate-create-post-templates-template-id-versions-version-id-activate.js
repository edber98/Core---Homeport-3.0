...
module.exports = {
  async sendgrid_activate_create_post_templates_template_id_versions_version_id_activate(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/templates/{template_id}/versions/{version_id}/activate";

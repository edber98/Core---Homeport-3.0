...
module.exports = {
  async retool_usage_report_app_details(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/usage/app_details";
    

    const query = {};
    if (d.start_date !== undefined && d.start_date !== null && d.start_date !== '') query["start_date"] = d.start_date;
    if (d.app_name !== undefined && d.app_name !== null && d.app_name !== '') query["app_name"] = d.app_name;
    ...
    if (d.next_token !== undefined && d.next_token !== null && d.next_token !== '') query["next_token"] = d.next_token;

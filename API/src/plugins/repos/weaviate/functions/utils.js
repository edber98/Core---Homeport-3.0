async function weaviateRequest(opts, requestPath, options = {}) {
  const credentials = (opts && opts.credentials) || {};
  const apiKey = credentials.apiKey;
  if (!apiKey && !credentials.allowAnonymous) return { ok: false, error: "Clé API manquante." };
...
module.exports = { utils: { weaviateRequest, parseJsonInput, compactJson, getPath, asArray, itemFromUnknown } };

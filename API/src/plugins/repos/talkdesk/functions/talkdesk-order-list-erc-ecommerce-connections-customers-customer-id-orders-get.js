...
module.exports = {
  async talkdesk_order_list_erc_ecommerce_connections_customers_customer_id_orders_get(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/connections/customers/{customer_id}/orders";

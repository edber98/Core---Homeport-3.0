...
module.exports = {
  async talkdesk_customer_get_erc_ecommerce_connections_customers_customer_id_get(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/connections/customers/{customer_id}";

...
module.exports = {
  async talkdesk_medication_statement_create_createmedicationstatement(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/healthcare/patients/{patient_id}/medication-statements";

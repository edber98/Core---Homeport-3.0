...
module.exports = {
  async talkdesk_order_get_erc_ecommerce_customers_customer_id_orders_order_id_get(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/customers/{customer_id}/orders/{order_id}";

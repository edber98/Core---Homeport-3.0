...
module.exports = {
  async talkdesk_available_slot_list_erc_ecommerce_customers_shipments_available_slots_get(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/customers/shipments/available-slots";

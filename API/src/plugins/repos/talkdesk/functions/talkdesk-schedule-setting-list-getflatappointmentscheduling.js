...
module.exports = {
  async talkdesk_schedule_setting_list_getflatappointmentscheduling(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/appointment-scheduling/virtual-agent/schedule-settings";

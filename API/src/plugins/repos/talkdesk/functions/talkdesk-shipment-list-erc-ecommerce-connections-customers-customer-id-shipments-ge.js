...
module.exports = {
  async talkdesk_shipment_list_erc_ecommerce_connections_customers_customer_id_shipments_ge(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/connections/customers/{customer_id}/shipments";

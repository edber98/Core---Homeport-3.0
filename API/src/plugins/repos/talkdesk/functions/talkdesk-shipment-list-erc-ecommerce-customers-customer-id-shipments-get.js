...
module.exports = {
  async talkdesk_shipment_list_erc_ecommerce_customers_customer_id_shipments_get(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/customers/{customer_id}/shipments";

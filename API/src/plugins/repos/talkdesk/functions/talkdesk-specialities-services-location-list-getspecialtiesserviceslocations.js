...
module.exports = {
  async talkdesk_specialities_services_location_list_getspecialtiesserviceslocations(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/locations-directory/staffs/specialities-services-locations";

...
module.exports = {
  async talkdesk_change_shipping_address_create_erc_ecommerce_connections_customers_customer_id_orders_order(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/connections/customers/{customer_id}/orders/{order_id}/change-shipping-address";

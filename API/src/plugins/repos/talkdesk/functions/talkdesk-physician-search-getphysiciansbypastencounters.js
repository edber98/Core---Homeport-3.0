...
module.exports = {
  async talkdesk_physician_search_getphysiciansbypastencounters(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/appointment-scheduling/healthcare/past-encounters/physicians";

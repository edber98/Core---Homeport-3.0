...
module.exports = {
  async talkdesk_replacecard_create_fsi_contacts_contact_id_cards_card_id_replacecard_post(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/fsi/contacts/{contact_id}/cards/{card_id}/replaceCard";

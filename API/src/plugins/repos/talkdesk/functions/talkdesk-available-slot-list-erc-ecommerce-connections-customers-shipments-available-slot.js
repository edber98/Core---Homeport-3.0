...
module.exports = {
  async talkdesk_available_slot_list_erc_ecommerce_connections_customers_shipments_available_slot(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/connections/customers/shipments/available-slots";

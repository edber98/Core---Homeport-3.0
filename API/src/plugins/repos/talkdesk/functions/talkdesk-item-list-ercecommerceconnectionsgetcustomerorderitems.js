...
module.exports = {
  async talkdesk_item_list_ercecommerceconnectionsgetcustomerorderitems(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/connections/customers/{customer_id}/orders/{order_id}/items";

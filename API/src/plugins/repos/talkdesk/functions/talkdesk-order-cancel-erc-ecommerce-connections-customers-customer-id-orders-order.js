...
module.exports = {
  async talkdesk_order_cancel_erc_ecommerce_connections_customers_customer_id_orders_order(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/connections/customers/{customer_id}/orders/{order_id}/cancel";

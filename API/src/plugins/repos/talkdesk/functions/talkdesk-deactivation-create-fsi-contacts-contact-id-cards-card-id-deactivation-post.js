...
module.exports = {
  async talkdesk_deactivation_create_fsi_contacts_contact_id_cards_card_id_deactivation_post(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/fsi/contacts/{contact_id}/cards/{card_id}/deactivation";

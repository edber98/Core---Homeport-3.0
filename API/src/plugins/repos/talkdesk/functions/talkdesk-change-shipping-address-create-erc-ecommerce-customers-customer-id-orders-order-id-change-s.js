...
module.exports = {
  async talkdesk_change_shipping_address_create_erc_ecommerce_customers_customer_id_orders_order_id_change_s(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/customers/{customer_id}/orders/{order_id}/change-shipping-address";

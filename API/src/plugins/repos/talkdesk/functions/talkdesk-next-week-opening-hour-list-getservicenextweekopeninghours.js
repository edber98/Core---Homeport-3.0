...
module.exports = {
  async talkdesk_next_week_opening_hour_list_getservicenextweekopeninghours(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/locations-directory/services/{service_id}/next-week-opening-hours";

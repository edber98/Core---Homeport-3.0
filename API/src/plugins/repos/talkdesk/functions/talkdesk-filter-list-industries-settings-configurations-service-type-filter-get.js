...
module.exports = {
  async talkdesk_filter_list_industries_settings_configurations_service_type_filter_get(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/industries-settings/configurations/{service}/{type}/filter";

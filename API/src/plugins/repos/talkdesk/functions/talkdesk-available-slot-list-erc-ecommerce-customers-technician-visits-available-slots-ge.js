...
module.exports = {
  async talkdesk_available_slot_list_erc_ecommerce_customers_technician_visits_available_slots_ge(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/erc/ecommerce/customers/technician-visits/available-slots";

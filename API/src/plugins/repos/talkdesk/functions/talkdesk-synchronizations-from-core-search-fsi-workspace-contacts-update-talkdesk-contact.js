...
module.exports = {
  async talkdesk_synchronizations_from_core_search_fsi_workspace_contacts_update_talkdesk_contact(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/fsi-workspace/contacts/synchronizations-from-core";

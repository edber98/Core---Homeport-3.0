async function browserbaseRequest(opts, requestPath, options = {}) {
  ...
  const baseUrl = String(credentials.baseUrl || "https://api.browserbase.com").replace(/\/+$/, "");
...
module.exports = { utils: { browserbaseRequest, parseJsonInput, compactJson, getPath, asArray, itemFromUnknown, buildBodyFromFields } };

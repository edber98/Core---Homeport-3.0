...
module.exports = {
  async front_application_message_template_update_sync_application_message_template(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/channels/{channel_id}/application_message_templates";

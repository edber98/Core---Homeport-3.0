...
module.exports = {
  async front_download_get_download_attachment_for_a_message_template(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/message_templates/{message_template_id}/download/{attachment_link_id}";

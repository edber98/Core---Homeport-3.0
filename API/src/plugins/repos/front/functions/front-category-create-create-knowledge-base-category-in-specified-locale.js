...
module.exports = {
  async front_category_create_create_knowledge_base_category_in_specified_locale(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/knowledge_bases/{knowledge_base_id}/locales/{locale}/categories";
    ...
    const body = {};
    if (d.parent_category_id !== undefined && d.parent_category_id !== null && d.parent_category_id !== '') {
      body["parent_category_id"] = d.parent_category_id;
    }

...
module.exports = {
  async front_tag_tag_update_a_tag(node, msg, inputs, opts) {
    ...
    if (d.parent_tag_id !== undefined && d.parent_tag_id !== null && d.parent_tag_id !== '') {
      body["parent_tag_id"] = d.parent_tag_id;
    }

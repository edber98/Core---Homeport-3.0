...
module.exports = {
  async front_category_create_create_knowledge_base_category_in_default_locale(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/knowledge_bases/{knowledge_base_id}/categories";

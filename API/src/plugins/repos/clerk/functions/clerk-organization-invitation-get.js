...
module.exports = {
  async clerk_organization_invitation_get(node, msg, inputs, opts) {
    const d = inputs || {};
    ...
    const res = await utils.clerkRequest(opts, `/organizations/${encodeURIComponent(organizationId)}/invitations/${encodeURIComponent(invitationId)}`);

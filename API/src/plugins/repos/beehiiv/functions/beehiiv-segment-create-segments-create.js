...
module.exports = {
  async beehiiv_segment_create_segments_create(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/publications/{publicationId}/segments";
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "name", "bodyKey": "name", "type": "string"}, {"key": "segmentInput", "bodyKey": "input", "type": "object"}]);

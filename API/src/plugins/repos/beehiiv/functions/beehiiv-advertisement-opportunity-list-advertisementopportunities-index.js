...
module.exports = {
  async beehiiv_advertisement_opportunity_list_advertisementopportunities_index(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/publications/{publicationId}/advertisement_opportunities";

...
module.exports = {
  async beehiiv_deletion_request_create_datadeletion_create(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/publications/{publicationId}/data_privacy/deletion_requests";
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "email", "bodyKey": "email", "type": "string"}]);

...
module.exports = {
  async beehiiv_bulk_subscription_update_list_bulksubscriptionupdates_index(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/publications/{publicationId}/bulk_subscription_updates";

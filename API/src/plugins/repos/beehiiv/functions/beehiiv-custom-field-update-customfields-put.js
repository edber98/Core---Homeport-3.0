...
module.exports = {
  async beehiiv_custom_field_update_customfields_put(node, msg, inputs, opts) {
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "display", "bodyKey": "display", "type": "string"}]);

...
module.exports = {
  async beehiiv_bulk_subscription_update_get_bulksubscriptionupdates_show(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/publications/{publicationId}/bulk_subscription_updates/{id}";

...
module.exports = {
  async ollama_model_pull(node, msg, inputs, opts) {
    ...
    log("Téléchargement du modèle en cours...");
    const res = await utils.ollamaRequest(opts, "/api/pull", { method: "POST", body });
    ...
    return {
      ...
      message: payload.status || "Modèle téléchargé.",

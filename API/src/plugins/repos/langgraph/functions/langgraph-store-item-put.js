...
module.exports = {
  async langgraph_store_item_put(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/store/items";
    ...
    const res = await utils.providerRequest(opts, reqPath, { method: 'PUT', query, body, headers });

...
module.exports = {
  async crisp_conversation_get(node, msg, inputs, opts) {
    ...
    const path = `/website/${encodeURIComponent(String(d.websiteId))}/conversation/${encodeURIComponent(String(d.sessionId))}`;
    const query = {};
    const body = {};

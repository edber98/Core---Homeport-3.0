...
module.exports = {
  async ebay_account_list_sales_taxes(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "https://api.ebay.com/sell/account/v1/sales_tax";
    

    const query = {};
    if (d.countrycode !== undefined && d.countrycode !== null && d.countrycode !== '') query["countrycode"] = d.countrycode;

...
module.exports = {
  async ebay_metadata_compatibility_get_property_values(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "https://api.ebay.com/sell/metadata/v1/compatibilities/get_compatibility_property_values";

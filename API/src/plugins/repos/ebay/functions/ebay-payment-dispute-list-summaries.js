...
module.exports = {
  async ebay_payment_dispute_list_summaries(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "https://api.ebay.com/sell/fulfillment/v1/payment_dispute_summary";
    ...
    if (d.filter !== undefined && d.filter !== null && d.filter !== '') query["filter"] = d.filter;
    if (d.sort !== undefined && d.sort !== null && d.sort !== '') query["sort"] = d.sort;

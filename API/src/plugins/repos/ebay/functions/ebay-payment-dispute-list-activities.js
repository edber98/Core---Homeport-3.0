...
module.exports = {
  async ebay_payment_dispute_list_activities(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "https://api.ebay.com/sell/fulfillment/v1/payment_dispute/{payment_dispute_id}/activity";

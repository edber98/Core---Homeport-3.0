...
module.exports = {
  async ebay_inventory_location_create(node, msg, inputs, opts) {
    ...
    const body = utils.buildBodyFromInputs(d, [{"source":"location","target":"location","type":"json"},{"source":"locationAdditionalInformation","target":"locationAdditionalInformation","type":"text"},{"source":"locationInstructions","target":"locationInstructions","type":"text"},{"source":"locationTypes","target":"locationTypes","type":"json"},{"source":"locationWebUrl","target":"locationWebUrl","type":"text"},{"source":"merchantLocationStatus","target":"merchantLocationStatus","type":"text"},{"source":"name","target":"name","type":"text"},{"source":"operatingHours","target":"operatingHours","type":"json"},{"source":"phone","target":"phone","type":"text"},{"source":"specialHours","target":"specialHours","type":"json"},{"source":"timeZoneId","target":"timeZoneId","type":"text"},{"source":"fulfillmentCenterSpecifications","target":"fulfillmentCenterSpecifications","type":"json"}]);

...
module.exports = {
  async ebay_custom_policy_list(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "https://api.ebay.com/sell/account/v1/custom_policy/";
    

    const query = {};
    if (d.policytypes !== undefined && d.policytypes !== null && d.policytypes !== '') query["policytypes"] = d.policytypes;

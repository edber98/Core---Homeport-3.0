...
module.exports = {
  async ebay_notification_subscription_disable(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "https://api.ebay.com/commerce/notification/v1/subscription/{subscriptionId}/disable";

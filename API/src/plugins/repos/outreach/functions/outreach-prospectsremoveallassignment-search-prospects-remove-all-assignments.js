...
module.exports = {
  async outreach_prospectsremoveallassignment_search_prospects_remove_all_assignments(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/batches/actions/prospectsRemoveAllAssignments";

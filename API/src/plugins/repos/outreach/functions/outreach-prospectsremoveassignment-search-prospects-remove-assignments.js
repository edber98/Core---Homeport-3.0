...
module.exports = {
  async outreach_prospectsremoveassignment_search_prospects_remove_assignments(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/batches/actions/prospectsRemoveAssignments";
    ...
    if (d.data_attributes_userids !== undefined && d.data_attributes_userids !== null && d.data_attributes_userids !== '') {
      body["data_attributes_userids"] = d.data_attributes_userids;
    }

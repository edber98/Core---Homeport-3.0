...
module.exports = {
  async outreach_contentcategoryownership_list_get_a_collection_of_content_category_ownerships(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/contentCategoryOwnerships";

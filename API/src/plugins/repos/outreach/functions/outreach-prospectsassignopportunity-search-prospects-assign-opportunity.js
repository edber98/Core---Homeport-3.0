...
module.exports = {
  async outreach_prospectsassignopportunity_search_prospects_assign_opportunity(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/batches/actions/prospectsAssignOpportunity";
    ...
    if (d.data_attributes_opportunityid !== undefined && d.data_attributes_opportunityid !== null && d.data_attributes_opportunityid !== '') {
      ...
      body["data"]["attributes"]["opportunityid"] = d.data_attributes_opportunityid;
    }

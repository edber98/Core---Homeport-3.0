...
module.exports = {
  async baseten_deactivate_create_deactivates_a_chain_deployment(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/chains/{chain_id}/deployments/{chain_deployment_id}/deactivate";

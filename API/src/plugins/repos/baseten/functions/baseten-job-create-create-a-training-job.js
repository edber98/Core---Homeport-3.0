...
module.exports = {
  async baseten_job_create_create_a_training_job(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/training_projects/{training_project_id}/jobs";
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'training_job']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "training_job", "type": "object"}]);

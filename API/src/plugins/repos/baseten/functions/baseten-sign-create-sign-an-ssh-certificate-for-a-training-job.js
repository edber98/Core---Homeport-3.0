...
module.exports = {
  async baseten_sign_create_sign_an_ssh_certificate_for_a_training_job(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/training_projects/{training_project_id}/jobs/{training_job_id}/ssh/sign";
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'public_key', 'replica_id']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "public_key", "type": "string"}, {"key": "replica_id", "type": "string"}]);

...
module.exports = {
  async baseten_sign_create_sign_an_ssh_certificate_for_an_inference_model(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/deployments/{deployment_id}/ssh/sign";

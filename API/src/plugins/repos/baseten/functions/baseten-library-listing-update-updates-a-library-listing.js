...
module.exports = {
  async baseten_library_listing_update_updates_a_library_listing(node, msg, inputs, opts) {
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'display_name', 'is_public']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "display_name", "type": "string"}, {"key": "is_public", "type": "boolean"}]);

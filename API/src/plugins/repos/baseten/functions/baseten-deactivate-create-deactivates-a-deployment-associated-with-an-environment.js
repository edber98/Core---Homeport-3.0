...
module.exports = {
  async baseten_deactivate_create_deactivates_a_deployment_associated_with_an_environment(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/environments/{env_name}/deactivate";

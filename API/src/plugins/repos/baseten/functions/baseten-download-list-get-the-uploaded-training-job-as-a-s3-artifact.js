...
module.exports = {
  async baseten_download_list_get_the_uploaded_training_job_as_a_s3_artifact(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/training_projects/{training_project_id}/jobs/{training_job_id}/download";

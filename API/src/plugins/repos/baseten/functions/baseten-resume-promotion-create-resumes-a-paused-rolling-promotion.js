...
module.exports = {
  async baseten_resume_promotion_create_resumes_a_paused_rolling_promotion(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/environments/{env_name}/resume_promotion";

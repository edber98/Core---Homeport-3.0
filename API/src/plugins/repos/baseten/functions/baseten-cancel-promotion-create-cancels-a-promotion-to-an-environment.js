...
module.exports = {
  async baseten_cancel_promotion_create_cancels_a_promotion_to_an_environment(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/environments/{env_name}/cancel_promotion";

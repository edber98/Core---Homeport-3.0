...
module.exports = {
  async baseten_checkpoint_list_list_trainer_server_checkpoints(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/trainer_sessions/{session_id}/trainers/{trainer_id}/checkpoints";

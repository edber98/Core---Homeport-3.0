...
module.exports = {
  async baseten_autoscaling_setting_update_updates_a_development_deployment_s_autoscaling_settings(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/deployments/development/autoscaling_settings";

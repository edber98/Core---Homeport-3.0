...
module.exports = {
  async baseten_environment_update_update_an_environment_s_settings(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/environments/{env_name}";
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'autoscaling_settings', 'promotion_settings']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "autoscaling_settings", "type": "object"}, {"key": "promotion_settings", "type": "object"}]);

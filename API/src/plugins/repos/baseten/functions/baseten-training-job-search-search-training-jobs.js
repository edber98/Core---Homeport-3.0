...
module.exports = {
  async baseten_training_job_search_search_training_jobs(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/training_jobs/search";
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'project_id', 'job_id', 'statuses', 'order_by']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "project_id", "type": "string"}, {"key": "job_id", "type": "string"}, {"key": "statuses", "type": "array"}, {"key": "order_by", "type": "array"}]);

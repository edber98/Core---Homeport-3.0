...
module.exports = {
  async baseten_deployment_create_adds_a_new_deployment_to_a_model(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/deployments";
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'source']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "source", "type": "object"}]);

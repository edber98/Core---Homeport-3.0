...
module.exports = {
  async baseten_autoscaling_setting_update_update_a_chainlet_environment_s_autoscaling_settings(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/chains/{chain_id}/environments/{env_name}/chainlet_settings/autoscaling_settings";
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'updates']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "updates", "type": "array"}]);

...
module.exports = {
  async baseten_deactivate_create_deactivates_a_development_deployment(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/deployments/development/deactivate";

...
module.exports = {
  async baseten_force_roll_forward_promotion_create_force_rolls_forward_a_rolling_promotion(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/environments/{env_name}/force_roll_forward_promotion";

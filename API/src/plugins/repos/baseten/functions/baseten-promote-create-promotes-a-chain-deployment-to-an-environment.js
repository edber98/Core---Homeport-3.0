...
module.exports = {
  async baseten_promote_create_promotes_a_chain_deployment_to_an_environment(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/chains/{chain_id}/environments/{env_name}/promote";
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'scale_down_previous_deployment', 'deployment_id']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "scale_down_previous_deployment", "type": "boolean"}, {"key": "deployment_id", "type": "string"}]);

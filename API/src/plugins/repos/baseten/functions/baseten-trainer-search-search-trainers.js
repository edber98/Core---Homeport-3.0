...
module.exports = {
  async baseten_trainer_search_search_trainers(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/trainers/search";
    ...
    const reserved = new Set(['pageSize', 'page', 'search', 'trainer_id']);
    ...
    const builtBody = utils.buildRequestBody(d, [{"key": "trainer_id", "type": "string"}]);

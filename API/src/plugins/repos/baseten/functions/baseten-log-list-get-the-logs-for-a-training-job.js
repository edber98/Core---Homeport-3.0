...
module.exports = {
  async baseten_log_list_get_the_logs_for_a_training_job(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/training_projects/{training_project_id}/jobs/{training_job_id}/logs";

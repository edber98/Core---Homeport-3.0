...
module.exports = {
  async baseten_download_list_gets_a_presigned_download_url_for_a_deployment_s_truss(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v1/models/{model_id}/deployments/{deployment_id}/download";

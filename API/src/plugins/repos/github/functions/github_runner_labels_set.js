...
module.exports = {
  async github_runner_labels_set(node, msg, inputs, opts) {
    const d = inputs || {};
    ...
    const res = await utils.githubRequest(opts, `/repos/${owner}/${repo}/actions/runners/${runner_id}/labels`, { method: "PUT", body: { labels } });

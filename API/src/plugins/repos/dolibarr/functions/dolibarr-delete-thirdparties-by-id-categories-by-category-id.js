...
module.exports = {
  async dolibarr_delete_thirdparties_by_id_categories_by_category_id(node, msg, inputs, opts) {
    ...
    const query = d.query || "";
    const path = `/thirdparties/${encodeURIComponent(d.id)}/categories/${encodeURIComponent(d.category_id)}` + (query ? ("?" + query) : "");

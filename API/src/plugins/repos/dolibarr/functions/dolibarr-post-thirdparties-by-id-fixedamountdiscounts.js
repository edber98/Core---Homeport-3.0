...
module.exports = {
  async dolibarr_post_thirdparties_by_id_fixedamountdiscounts(node, msg, inputs, opts) {
    ...
    const path = `/thirdparties/${encodeURIComponent(d.id)}/fixedamountdiscounts` + (query ? ("?" + query) : "");

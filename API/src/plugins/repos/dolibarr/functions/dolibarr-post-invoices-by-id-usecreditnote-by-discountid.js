...
module.exports = {
  async dolibarr_post_invoices_by_id_usecreditnote_by_discountid(node, msg, inputs, opts) {
    ...
    const path = `/invoices/${encodeURIComponent(d.id)}/usecreditnote/${encodeURIComponent(d.discountid)}` + (query ? ("?" + query) : "");

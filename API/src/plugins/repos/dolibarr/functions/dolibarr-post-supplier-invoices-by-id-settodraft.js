...
module.exports = {
  async dolibarr_post_supplier_invoices_by_id_settodraft(node, msg, inputs, opts) {
    ...
    const path = `/supplier_invoices/${encodeURIComponent(d.id)}/settodraft` + (query ? ("?" + query) : "");

...
module.exports = {
  async dolibarr_get_thirdparties_accounts_by_site_by_key_account(node, msg, inputs, opts) {
    ...
    const query = d.query || "";
    const path = `/thirdparties/accounts/${encodeURIComponent(d.site)}/${encodeURIComponent(d.key_account)}` + (query ? ("?" + query) : "");

...
module.exports = {
  async dolibarr_post_invoices_by_id_markascreditavailable(node, msg, inputs, opts) {
    ...
    const path = `/invoices/${encodeURIComponent(d.id)}/markAsCreditAvailable` + (query ? ("?" + query) : "");

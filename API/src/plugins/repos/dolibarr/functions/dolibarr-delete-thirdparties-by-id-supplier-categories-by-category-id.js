...
module.exports = {
  async dolibarr_delete_thirdparties_by_id_supplier_categories_by_category_id(node, msg, inputs, opts) {
    ...
    const query = d.query || "";
    const path = `/thirdparties/${encodeURIComponent(d.id)}/supplier_categories/${encodeURIComponent(d.category_id)}` + (query ? ("?" + query) : "");

...
module.exports = {
  async dolibarr_post_receptions_createfromorder_by_orderid(node, msg, inputs, opts) {
    ...
    const path = `/receptions/createfromorder/${encodeURIComponent(d.orderid)}` + (query ? ("?" + query) : "");

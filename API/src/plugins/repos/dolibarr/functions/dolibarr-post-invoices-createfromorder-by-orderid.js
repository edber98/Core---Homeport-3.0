...
module.exports = {
  async dolibarr_post_invoices_createfromorder_by_orderid(node, msg, inputs, opts) {
    ...
    const path = `/invoices/createfromorder/${encodeURIComponent(d.orderid)}` + (query ? ("?" + query) : "");

...
module.exports = {
  async dolibarr_post_knowledgemanagement_by_id_validate(node, msg, inputs, opts) {
    ...
    const path = `/knowledgemanagement/${encodeURIComponent(d.id)}/validate` + (query ? ("?" + query) : "");

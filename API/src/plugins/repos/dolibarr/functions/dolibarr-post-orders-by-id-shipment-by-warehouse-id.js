...
module.exports = {
  async dolibarr_post_orders_by_id_shipment_by_warehouse_id(node, msg, inputs, opts) {
    ...
    const path = `/orders/${encodeURIComponent(d.id)}/shipment/${encodeURIComponent(d.warehouse_id)}` + (query ? ("?" + query) : "");

...
module.exports = {
  async dolibarr_delete_tickets_by_id_contact_by_contactid_by_type(node, msg, inputs, opts) {
    ...
    const query = d.query || "";
    const path = `/tickets/${encodeURIComponent(d.id)}/contact/${encodeURIComponent(d.contactid)}/${encodeURIComponent(d.type)}` + (query ? ("?" + query) : "");

...
module.exports = {
  async dolibarr_put_contracts_by_id_lines_by_lineid_activate(node, msg, inputs, opts) {
    ...
    const path = `/contracts/${encodeURIComponent(d.id)}/lines/${encodeURIComponent(d.lineid)}/activate` + (query ? ("?" + query) : "");

...
module.exports = {
  async dolibarr_post_users_by_id_notificationsbycode_by_code(node, msg, inputs, opts) {
    ...
    const path = `/users/${encodeURIComponent(d.id)}/notificationsbycode/${encodeURIComponent(d.code)}` + (query ? ("?" + query) : "");

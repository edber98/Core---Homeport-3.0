...
module.exports = {
  async dolibarr_put_tasks_by_id_tasks_by_taskid(node, msg, inputs, opts) {
    ...
    const path = `/tasks/${encodeURIComponent(d.id)}/tasks/${encodeURIComponent(d.taskid)}` + (query ? ("?" + query) : "");

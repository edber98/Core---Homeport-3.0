...
module.exports = {
  async dolibarr_proposal_create(node, msg, inputs, opts) {
    ...
    if (d.fin_validite !== undefined && d.fin_validite !== null && d.fin_validite !== "") body.fin_validite = d.fin_validite;
    ...
    const res = await utils.dolibarrRequest(opts, "/proposals", { method: "POST", body });

...
module.exports = {
  async dolibarr_delete_bankaccounts_by_id_lines_by_line_id(node, msg, inputs, opts) {
    ...
    const query = d.query || "";
    const path = `/bankaccounts/${encodeURIComponent(d.id)}/lines/${encodeURIComponent(d.line_id)}` + (query ? ("?" + query) : "");

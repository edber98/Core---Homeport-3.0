...
module.exports = {
  async dolibarr_put_mailings_by_id_updatetarget_by_targetid(node, msg, inputs, opts) {
    ...
    const path = `/mailings/${encodeURIComponent(d.id)}/updateTarget/${encodeURIComponent(d.targetid)}` + (query ? ("?" + query) : "");

...
module.exports = {
  async dolibarr_proposal_add_line(node, msg, inputs, opts) {
    ...
    const res = await utils.dolibarrRequest(opts, `/proposals/${encodeURIComponent(d.id)}/lines`, { method: "POST", body });

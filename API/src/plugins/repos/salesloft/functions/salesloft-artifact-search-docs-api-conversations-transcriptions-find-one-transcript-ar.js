...
module.exports = {
  async salesloft_artifact_search_docs_api_conversations_transcriptions_find_one_transcript_ar(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v2/transcriptions/{id}/artifact";

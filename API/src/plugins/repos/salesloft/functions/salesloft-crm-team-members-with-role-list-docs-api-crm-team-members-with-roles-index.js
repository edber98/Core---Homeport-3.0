...
module.exports = {
  async salesloft_crm_team_members_with_role_list_docs_api_crm_team_members_with_roles_index(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v2/crm_team_members_with_roles";

...
module.exports = {
  async salesloft_sentence_search_docs_api_conversations_transcriptions_find_one_transcript_se(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v2/transcriptions/{id}/sentences";

...
module.exports = {
  async salesloft_email_template_attachment_list_docs_api_email_template_attachments_index(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v2/email_template_attachments";

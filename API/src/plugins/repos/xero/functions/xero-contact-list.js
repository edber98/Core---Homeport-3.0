...
module.exports = {
  async xero_contact_list(node, msg, inputs, opts) {
    ...
    if (d.includearchived !== undefined && d.includearchived !== null && d.includearchived !== '') query["includearchived"] = d.includearchived;
    if (d.summaryonly !== undefined && d.summaryonly !== null && d.summaryonly !== '') query["summaryonly"] = d.summaryonly;
    if (d.searchterm !== undefined && d.searchterm !== null && d.searchterm !== '') query["searchterm"] = d.searchterm;

...
const BODY_FIELDS = [
  ...
  {
    "key": "schedule_next_scheduled_date",
    "type": "text",
    "bodyPath": [
      "Schedule",
      "NextScheduledDate"
...
module.exports = {
  async xero_repeating_invoice_update(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/RepeatingInvoices/{repeatingInvoiceId}";

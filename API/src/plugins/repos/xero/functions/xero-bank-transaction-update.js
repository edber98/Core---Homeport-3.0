...
const BODY_FIELDS = [
  ...
  {
    "key": "bank_account_bank_account_number",
    "type": "text",
    "bodyPath": [
      "BankAccount",
      "BankAccountNumber"
  ...
  {
    "key": "bank_account_bank_account_type",
    "type": "text",
    "bodyPath": [
      "BankAccount",
      "BankAccountType"
  ...
  {
    "key": "bank_account_currency_code",
    "type": "text",
    "bodyPath": [
      "BankAccount",
      "CurrencyCode"
  ...
  {
    "key": "bank_account_enable_payments_to_account",
    "type": "checkbox",
    "bodyPath": [
      "BankAccount",
  ...
  {
    "key": "bank_account_show_in_expense_claims",
    "type": "checkbox",
    "bodyPath": [
      "BankAccount",
      "ShowInExpenseClaims"
  ...
  {
    "key": "bank_account_system_account",
    "type": "text",
    "bodyPath": [
      "BankAccount",
      "SystemAccount"
  ...
  {
    "key": "bank_account_reporting_code",
    "type": "text",
    "bodyPath": [
      "BankAccount",
      "ReportingCode"
  ...
  {
    "key": "bank_account_reporting_code_name",
    "type": "text",
    "bodyPath": [
      "BankAccount",
      "ReportingCodeName"
  ...
  {
    "key": "bank_account_has_attachments",
    "type": "checkbox",
    "bodyPath": [
      "BankAccount",
      "HasAttachments"
  ...
  {
    "key": "bank_account_updated_date_utc",
    "type": "text",
    "bodyPath": [
      "BankAccount",
      "UpdatedDateUTC"
  ...
  {
    "key": "bank_account_add_to_watchlist",
    "type": "checkbox",
    "bodyPath": [
      "BankAccount",
      "AddToWatchlist"
  ...
  {
    "key": "bank_account_validation_errors",
    "type": "json",
    "bodyPath": [
      "BankAccount",
      "ValidationErrors"
...
module.exports = {
  async xero_bank_transaction_update(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/BankTransactions/{bankTransactionId}";

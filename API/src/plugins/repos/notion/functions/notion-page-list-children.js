...
module.exports = {
  async notion_page_list_children(node, msg, inputs, opts) {
    ...
    return { ok: true, blocks, hasMore: !!res.data?.has_more, nextCursor: res.data?.next_cursor || "" , totalCount: blocks.length };
  }
};

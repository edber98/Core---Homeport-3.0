...
module.exports = {
  async webflow_form_submission_list_by_site(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = '/sites/{site_id}/form_submissions';
    ...
    if (d.elementId !== undefined && d.elementId !== null && d.elementId !== '') query.elementId = d.elementId;

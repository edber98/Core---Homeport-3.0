...
module.exports = {
  async attio_value_search_list_attribute_values_for_a_list_entry(node, msg, inputs, opts) {
    const log = (opts && opts.log) ? opts.log : () => {};
    const d = inputs || {};
    let reqPath = "/v2/lists/{list}/entries/{entry_id}/attributes/{attribute}/values";

// Roster frontend — miroir de API/src/ai/subagent/roster.js.
// Utilisé quand le backend n'a pas enrichi l'event (cas legacy) ou pour
// afficher un badge à partir du seul `subagentType`.
...
export const AI_ROSTER: Record<string, AgentProfile> = {
  research: {
    type: 'research', name: 'Tim', emoji: '🌐', color: '#1890ff',
    tagline: 'explore le web', figure: 'Tim Berners-Lee', years: '1955 – ',
  ...
  file_analyzer: {
    type: 'file_analyzer', name: 'Ada', emoji: '📊', color: '#13c2c2',
    tagline: 'décode tes données', figure: 'Ada Lovelace', years: '1815 – 1852',
  ...
  doc_writer: {
    type: 'doc_writer', name: 'Donald', emoji: '✒️', color: '#722ed1',
    tagline: 'rédige tes documents', figure: 'Donald Knuth', years: '1938 – ',
  ...
  general: {
    type: 'general', name: 'Denis', emoji: '📚', color: '#e61982',
    tagline: 'synthétise tout', figure: 'Denis Diderot', years: '1713 – 1784',
  ...
  memory_extractor: {
    type: 'memory_extractor', name: 'Van', emoji: '🧠', color: '#fa8c16',
    tagline: 'archive ta mémoire', figure: 'Vannevar Bush', years: '1890 – 1974',
  ...
  project_doc_writer: {
    type: 'project_doc_writer', name: 'Hypatie', emoji: '🏛️', color: '#52c41a',
    tagline: 'garde le savoir du projet', figure: "Hypatie d'Alexandrie", years: '~355 – 415',
  ...
  code_runner: {
    type: 'code_runner', name: 'Alan', emoji: '⚙️', color: '#2f54eb',
    tagline: 'exécute ton code', figure: 'Alan Turing', years: '1912 – 1954',
  ...
  logician: {
    type: 'logician', name: 'René', emoji: '🧩', color: '#595959',
    tagline: 'raisonne avec méthode', figure: 'René Descartes', years: '1596 – 1650',
  ...
  security_auditor: {
    type: 'security_auditor', name: 'Claude', emoji: '🔒', color: '#434343',
    tagline: 'audite la sécurité', figure: 'Claude Shannon', years: '1916 – 2001',
  ...
  vision_analyst: {
    type: 'vision_analyst', name: 'Hedy', emoji: '👁️', color: '#eb2f96',
    tagline: 'comprend les images', figure: 'Hedy Lamarr', years: '1914 – 2000',
  ...
  voice_handler: {
    type: 'voice_handler', name: 'Graham', emoji: '🎤', color: '#d46b08',
    tagline: 'transcrit et parle', figure: 'Alexander Graham Bell', years: '1847 – 1922',
  ...
  data_scientist: {
    type: 'data_scientist', name: 'Marie', emoji: '🔬', color: '#cf1322',
    tagline: 'analyse tes chiffres', figure: 'Marie Curie', years: '1867 – 1934',
  ...
  dataviz: {
    type: 'dataviz', name: 'Florence', emoji: '📈', color: '#ff70a6',
    tagline: 'visualise tes données', figure: 'Florence Nightingale', years: '1820 – 1910',
  ...
  automation_architect: {
    type: 'automation_architect', name: 'Isaac', emoji: '🤖', color: '#531dab',
    tagline: 'orchestre les agents', figure: 'Isaac Asimov', years: '1920 – 1992',
  ...
  math_proof: {
    type: 'math_proof', name: 'Kurt', emoji: '∑', color: '#1d39c4',
    tagline: 'prouve les théorèmes', figure: 'Kurt Gödel', years: '1906 – 1978',
  ...
  expert_system: {
    type: 'expert_system', name: 'Marvin', emoji: '🧭', color: '#7e57c2',
    tagline: 'raisonne sur les règles', figure: 'Marvin Minsky', years: '1927 – 2016',
...
export function getAgentProfile(type?: string | null): AgentProfile | null {
  if (!type) return null;
  return AI_ROSTER[type] || null;
}

/** Merge backend-provided agent fields with local roster fallback. */
export function resolveAgentProfile(partial: {
  subagentType?: string;
  agentName?: string;
  agentEmoji?: string;
  agentColor?: string;
  ...
  return {
    ...
    figure: partial.agentFigure || fromType?.figure || '',
    years: fromType?.years || '',
    field: fromType?.field || '',
    bio: fromType?.bio || '',
  };
}

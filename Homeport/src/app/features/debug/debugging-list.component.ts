...
@Component({
  ...
  styles: [`
    ...
    .card { display:flex; align-items:center; gap:14px; padding:14px 14px; border-radius:16px; cursor:pointer; background: #fff; box-shadow: 0 8px 24px rgba(0,0,0,0.04); transition: transform .15s ease, box-shadow .15s ease, border-color .15s ease; }
    ...
    .desc { color:#8b8b8b; font-size: 12.5px; margin-top:4px; overflow: hidden; text-overflow: ellipsis; }
  `]
})

  ...
  { path: 'public/form/:flowId/:nodeId', loadComponent: () => import('./features/flow/public-form-start.component').then(m => m.PublicFormStartComponent), title: 'Formulaire' },
    ...
    // Auth-only layout (no navbar)
    {
        ...
        children: [
            ...
            { path: 'sso/complete', loadComponent: () => import('./features/users/sso-callback.component').then(m => m.SsoCallbackComponent), title: 'SSO — connexion' },
...

    {
        ...
        children: [
            ...
            { path: 'plugin-repos', canActivate: [adminGuard], loadComponent: () => import('./features/plugins/plugin-repo-list.component').then(m => m.PluginRepoListComponent), title: 'Plugins — Repos' },
            { path: 'plugin-repos/editor', canActivate: [adminGuard], loadComponent: () => import('./features/plugins/plugin-repo-editor.component').then(m => m.PluginRepoEditorComponent), title: 'Plugins — Éditeur de repo' },
            { path: 'plugin-repos/viewer', canActivate: [adminGuard], loadComponent: () => import('./features/plugins/plugin-repo-viewer.component').then(m => m.PluginRepoViewerComponent), title: 'Plugins — Détails du repo' },

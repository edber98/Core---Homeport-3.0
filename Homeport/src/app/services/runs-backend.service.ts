...
export class RunsBackendService {
  ...
  simulateMsg(flowId: string, targetNodeId: string, mode: 'engine'|'engine_split'|'all'|'default' = 'engine'): Observable<{ targetNodeId?: string; scenarios: Array<{ id: string; index: number; label: string; msgIn: any; argsPre?: any; argsPost?: any; path?: { edges?: Array<{ sourceId: string; targetId: string; sourceHandle?: string }> }; trace?: Array<{ nodeId: string; kind?: string; startedAt?: string; finishedAt?: string; handlesUsed?: string[]; resultPreview?: Array<{ key: string; type: string }> }> }> }> {
    return this.api.post<{ targetNodeId?: string; scenarios: Array<{ id: string; index: number; label: string; msgIn: any; argsPre?: any; argsPost?: any; path?: { edges?: Array<{ sourceId: string; targetId: string; sourceHandle?: string }> }; trace?: Array<{ nodeId: string; kind?: string; startedAt?: string; finishedAt?: string; handlesUsed?: string[]; resultPreview?: Array<{ key: string; type: string }> }> }> }>(`/api/flows/${encodeURIComponent(flowId)}/simulate-msg`, { targetNodeId, mode });
  }
